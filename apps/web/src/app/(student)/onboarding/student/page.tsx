...
import type { Faculty, Group, Paginated, TokenResponse } from "@/lib/types";
...
export default function StudentOnboardingPage() {
  ...
  const { role, applyAuth, refresh } = useAppAuth();
  ...
  const selectGroup = useMutation({
    mutationFn: async (group_id: number) => {
      ...
      await api.patch("/api/v1/students/me", { group_id }, { auth: "student" });
      return null;
    },
